...
return [
    ...
    */
    ...
    'custom' => [
        'nome' => [
            'min' => 'Este nome é muito curto',
        ],
        'descricao' => [
            'min' => 'Esta descrição é muito curta',
            'required' => 'Uma categoria não pode ser criada sem descrição.'
        ]
    ],
    ...
    */
    ...
    'attributes' => ['nome' => 'Nome', 'descricao' =>'Descrição'],
